...
namespace Project_1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (labelText.Contains(".csv"))
            {
                MessageBox.Show("Se ha generado un grafico circular de los departamentos con respecto a su cantidad de municipios");
                
                Form2 f2 = new Form2(controller.RetrievePieData());
                f2.Show();
            }
            else
            {
